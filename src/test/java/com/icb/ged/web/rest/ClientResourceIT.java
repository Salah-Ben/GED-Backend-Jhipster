...
import com.icb.ged.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().type(DEFAULT_TYPE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().type(UPDATED_TYPE);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.type(UPDATED_TYPE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.type(UPDATED_TYPE);
